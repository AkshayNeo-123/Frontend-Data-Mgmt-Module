...
//   components: any[] = []; // For storing component rows
//   availableComponents: string[] = ['Component A', 'Component B', 'Component C']; // Dummy values, replace with actual list if needed
...
export class AddRecipyComponent implements OnInit {
  ...
  availableComponents: any[] = []; // Now dynamic from API
